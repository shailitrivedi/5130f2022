            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Update Complaints List</h4>
                                ...
                                <div class="table-responsive">
                                    <table id="default_order" class="table table-striped table-bordered display no-wrap" style="width:100%">
                                        ...
                                        <tbody>
											<c:forEach var="com" items="${AllPendingComplaint}">
                                            <tr>
                                                <td>${com.id}</td>
                                                <td>${com.type}</td>
                                                <td>${com.nature}</td>
                                                <td>${com.detail}</td>
                                                <td>
                                                <a href="/admin/blockComplaint?id=${com.id}" class="btn waves-effect waves-light btn-rounded btn-dark viewBtn">Block</a>
                                                </td>
                                            </tr>
                                            </c:forEach>
                                        </tbody>
